<!-- Offcanvas Sidebar -->
<div class="offcanvas offcanvas-start sidebar-nav" style="background-color:#bae8e8;" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas-body p-3">
        <nav class="navbar-dark">
            <ul class="navbar-nav">
                ...
                <!-- Dashboard Link -->
                <li>
                    <a href="{{ url('dashboard_page') }}" class="nav-link px-3 text-black d-flex align-items-center {{ request()->is('dashboard_page') ? 'active-link' : '' }}">
                ...
                <!-- More Links -->
                <li>
                    <a href="{{ url('profile') }}" class="nav-link px-3 text-black d-flex align-items-center {{ request()->is('profile') ? 'active-link' : '' }}">
                ...
                <li>
                    <a href="{{ url('student') }}" class="nav-link px-3 text-black d-flex align-items-center {{ request()->is('student') ? 'active-link' : '' }}">
                ...
                <li>
                    <a href="{{ url('advisers') }}" class="nav-link px-3 text-black d-flex align-items-center {{ request()->is('advisers') ? 'active-link' : '' }}">
                ...
                <li>
                    <a href="{{ url('registration') }}" class="nav-link px-3 text-black d-flex align-items-center {{ request()->is('registration') ? 'active-link' : '' }}">
                ...
                <li>
                    <a href="{{ url('events') }}" class="nav-link px-3 text-black d-flex align-items-center {{ request()->is('events') ? 'active-link' : '' }}">
                ...
                <li>
                    <a href="#" class="mb-2 nav-link px-3 text-black d-flex align-items-center">
                ...
                <li>
                    <a href="{{ url('device_page') }}" class="nav-link px-3 text-black d-flex align-items-center {{ request()->is('device_page') ? 'active-link' : '' }}">
                ...
                <li>
                    <a href="{{ url('accounts') }}" class="nav-link px-3 text-black d-flex align-items-center {{ request()->is('accounts') ? 'active-link' : '' }}">
                ...
                <li>
                    <a href="{{ url('manage_orgs_page') }}" class="nav-link px-3 text-black d-flex align-items-center {{ request()->is('manage_orgs_page') ? 'active-link' : '' }}">
                ...
                @if (Auth::user()->role !== 'officer')
                    <li>
                        <a href="{{ url('logs') }}" class="nav-link px-3 text-black d-flex align-items-center {{ request()->is('logs') ? 'active-link' : '' }}">
